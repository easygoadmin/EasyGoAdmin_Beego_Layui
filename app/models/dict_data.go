...
type DictData struct {
	...
	Name       string    `orm:"column(name);size(50)" description:"字典项名称"`
	Code       string    `orm:"column(code);size(50)" description:"字典项值"`
	DictId     int       `orm:"column(dict_id)" description:"字典类型ID"`
	Status     int       `orm:"column(status)" description:"状态：1在用 2停用"`
	Note       string    `orm:"column(note);size(300);null" description:"备注"`
