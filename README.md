...
## 👷 开发者信息
* 系统名称：EasyGoAdmin敏捷开发框架Beego+Layui版本
* 软件作者：@半城风雨
* 软件出处：深圳EasyGoAdmin研发中心
* 官网网址：[http://www.easygoadmin.vip](http://www.easygoadmin.vip)
* 文档网址：[http://docs.beego.layui.easygoadmin.vip](http://docs.beego.layui.easygoadmin.vip)

## 🎨 系统演示

+ 演示地址：http://manage.beego.layui.easygoadmin.vip
